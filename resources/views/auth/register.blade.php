@extends('layouts.main', ['class' => 'off-canvas-sidebar', 'activePage' => 'register', 'title' => __('UTI-CNDC')])
          ...
          <div class="card-body ">
            ...
            <div class="bmd-form-group{{ $errors->has('username') ? ' has-danger' : '' }} mt-3">
              ...
              @if ($errors->has('username'))
                <div id="username-error" class="error text-danger pl-3" for="name" style="display: block;">
