@extends('layouts.main', ['activePage' => 'areas', 'titlePage' => 'Editar Area'])
@section('content')
<div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form action="{{route('areas.update', $area)}}" method="post" class="form-horizontal">
            @csrf
            @method('put')
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <input type="text" class="form-control" name="nombre" placeholder="Ingrese el nombre" value="{{ $area->nombre }}" autofocus>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <input type="text" class="form-control" name="abreviado" placeholder="Ingrese la abreviatura" value="{{ $area->abreviado }}" >
